<div class="helpdeskAtms cake-elements form">
	<div class="page-header">
		<h2><?php echo __('Add ATM Location'); ?></h2>
	</div>

	<?php echo $this->Form->create('HelpdeskAtm'); ?>
	<div class="form-bg">
		<?php
		$strOpts = "<option value=\"\" selected=\"selected\">--- parent network ---</option>";
...
<div class="actions">
	...
	<ul>
		<li>
		<?php
		echo $this->Html->link("<i class=\"icon-file\"></i> ".__('List ATM Locations'), array('action' => 'index'), array('class' => 'btn btn-default', 'escape' => false));
		?>
	    </li>
	</ul>
