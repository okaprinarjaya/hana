<div class="users cake-elements form">
	<div class="page-header">
		<h2><?php echo __('Edit PIC Account'); ?></h2>
	</div>
	...
	echo $this->Form->input('user_level_id', array('options' => $user_levels));
...
<div class="actions">
	...
	<ul>
		<li>
		<?php
		echo $this->Html->link("<i class=\"icon-list\"></i> ".__('List PIC'), array('action' => 'index', 'pic'), array('class' => 'btn btn-default', 'escape' => false));
		?>
	    </li>
